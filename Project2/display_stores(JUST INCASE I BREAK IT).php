     ...
     <TD> <strong> Location(Latitude,Lognitude) </strong>
      \n";
           ...
           while($row = mysqli_fetch_array($res)){
              ...
              // array_push($ids, $id); //creates an array of ids that can be used to create a location
              // array_push($names, $Name); //creates an array of ids that can be used to create a location
              // array_push($addresses, $Address); //creates an array of ids that can be used to create a location
              // array_push($cities, $City); //creates an array of ids that can be used to create a location
              // array_push($states, $State); //creates an array of ids that can be used to create a location
              // array_push($zipcodes, $Zipcode); //creates an array of ids that can be used to create a location
              //
              // array_push($lat,$latitude); //gets lat into an array
              // array_push($long,$longitude); //gets long into an array
              //
              //
              // array_push($locations, $location ); //creates an array of ids that can be used to create a location
...
//^^all this is good
            ...
            $i++;
              ...
              // create an object for each one of thee locations and just access those
              // TODO IF THIS DOESNT WORK THEN JUST PASS THE VARIABLES IN
           ...
           // echo "$location";
             // echo "PLACES PHP SIDE: $places <BR>";
...
var zipcodes = <?php echo '["' . implode('", "', $zipcodes) . '"]' ?>;
...
var lats = <?php echo '["' . implode('", "', $lat) . '"]' ?>;
var long = <?php echo '["' . implode('", "', $long) . '"]' ?>;


// document.write(`IDS:  ${ids}`);
...
//get variables here?
	...
	var markerIcon = {
        ...
        var marker, m;
        var MarkerLocations= [
          //TODO how to get the PHP variables into here


[ ids[0] , names[0] , lats[0] ,long[0] , addresses[0] ,cities[0] , states[0], zipcodes[0] ] , //works
